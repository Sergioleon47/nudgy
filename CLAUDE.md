...
- Recurrencia dentro del mismo dia, para hidratacion/medicacion durante entrenamientos largos u otras rutinas: "cada 2 horas" / "every 2 hours" (tambien "cada hora" / "every hour"). Se ancla a la hora exacta en que se escribio o edito la nota (o a una hora explicita si el usuario la da, ej. "cada 2 horas a las 8am"). Limitacion conocida: "hasta X" con este tipo solo entiende una fecha de corte (p. ej. "hasta el 15 de agosto"), no una hora del dia como "hasta las 8pm" — no hay forma todavia de limitar la recurrencia horaria a una ventana dentro del mismo dia
